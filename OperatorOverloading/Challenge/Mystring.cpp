...
Mystring operator+=(const Mystring &mystring, const Mystring &mystring2){
    char *buff = new char[strlen(mystring.str)+strlen(mystring2.str)];
    strcat(mystring.str, mystring2.str);
